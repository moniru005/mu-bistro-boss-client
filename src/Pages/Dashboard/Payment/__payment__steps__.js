 ...
 * 5. create payment intent post on the server. and return client secret. install stripe oni the server side and get client secret. make sure you used the payment method types: ['card']
